...
import com.cheatedpixel.cheatedpixeldungeon.items.armor.DuelistArmor;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.HuntressArmor;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.LeatherArmor;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.MageArmor;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.MailArmor;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.PlateArmor;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.RogueArmor;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.ScaleArmor;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.WarriorArmor;
import com.cheatedpixel.cheatedpixeldungeon.items.artifacts.AlchemistsToolkit;
import com.cheatedpixel.cheatedpixeldungeon.items.artifacts.Artifact;
import com.cheatedpixel.cheatedpixeldungeon.items.artifacts.ChaliceOfBlood;
...
import com.cheatedpixel.cheatedpixeldungeon.items.artifacts.EtherealChains;
import com.cheatedpixel.cheatedpixeldungeon.items.artifacts.HornOfPlenty;
import com.cheatedpixel.cheatedpixeldungeon.items.artifacts.MasterThievesArmband;
import com.cheatedpixel.cheatedpixeldungeon.items.artifacts.SandalsOfNature;
import com.cheatedpixel.cheatedpixeldungeon.items.artifacts.TalismanOfForesight;
import com.cheatedpixel.cheatedpixeldungeon.items.artifacts.TimekeepersHourglass;
import com.cheatedpixel.cheatedpixeldungeon.items.artifacts.UnstableSpellbook;
...
import com.cheatedpixel.cheatedpixeldungeon.items.quest.Pickaxe;
import com.cheatedpixel.cheatedpixeldungeon.items.rings.Ring;
import com.cheatedpixel.cheatedpixeldungeon.items.rings.RingOfAccuracy;
import com.cheatedpixel.cheatedpixeldungeon.items.rings.RingOfArcana;
import com.cheatedpixel.cheatedpixeldungeon.items.rings.RingOfElements;
import com.cheatedpixel.cheatedpixeldungeon.items.rings.RingOfEnergy;
import com.cheatedpixel.cheatedpixeldungeon.items.rings.RingOfEvasion;
import com.cheatedpixel.cheatedpixeldungeon.items.rings.RingOfForce;
import com.cheatedpixel.cheatedpixeldungeon.items.rings.RingOfFuror;
import com.cheatedpixel.cheatedpixeldungeon.items.rings.RingOfHaste;
import com.cheatedpixel.cheatedpixeldungeon.items.rings.RingOfMight;
import com.cheatedpixel.cheatedpixeldungeon.items.rings.RingOfSharpshooting;
import com.cheatedpixel.cheatedpixeldungeon.items.rings.RingOfTenacity;
import com.cheatedpixel.cheatedpixeldungeon.items.rings.RingOfWealth;
...
import com.cheatedpixel.cheatedpixeldungeon.items.scrolls.ScrollOfTerror;
...
import com.cheatedpixel.cheatedpixeldungeon.items.spells.Spell;
import com.cheatedpixel.cheatedpixeldungeon.items.stones.Runestone;
import com.cheatedpixel.cheatedpixeldungeon.items.stones.StoneOfAggression;
import com.cheatedpixel.cheatedpixeldungeon.items.stones.StoneOfAugmentation;
import com.cheatedpixel.cheatedpixeldungeon.items.stones.StoneOfBlast;
import com.cheatedpixel.cheatedpixeldungeon.items.stones.StoneOfBlink;
import com.cheatedpixel.cheatedpixeldungeon.items.stones.StoneOfClairvoyance;
import com.cheatedpixel.cheatedpixeldungeon.items.stones.StoneOfDeepSleep;
import com.cheatedpixel.cheatedpixeldungeon.items.stones.StoneOfDetectMagic;
import com.cheatedpixel.cheatedpixeldungeon.items.stones.StoneOfEnchantment;
import com.cheatedpixel.cheatedpixeldungeon.items.stones.StoneOfFear;
import com.cheatedpixel.cheatedpixeldungeon.items.stones.StoneOfFlock;
import com.cheatedpixel.cheatedpixeldungeon.items.stones.StoneOfIntuition;
import com.cheatedpixel.cheatedpixeldungeon.items.stones.StoneOfShock;
import com.cheatedpixel.cheatedpixeldungeon.items.trinkets.ChaoticCenser;
import com.cheatedpixel.cheatedpixeldungeon.items.trinkets.DimensionalSundial;
import com.cheatedpixel.cheatedpixeldungeon.items.trinkets.ExoticCrystals;
import com.cheatedpixel.cheatedpixeldungeon.items.trinkets.EyeOfNewt;
import com.cheatedpixel.cheatedpixeldungeon.items.trinkets.MimicTooth;
import com.cheatedpixel.cheatedpixeldungeon.items.trinkets.MossyClump;
import com.cheatedpixel.cheatedpixeldungeon.items.trinkets.ParchmentScrap;
import com.cheatedpixel.cheatedpixeldungeon.items.trinkets.PetrifiedSeed;
import com.cheatedpixel.cheatedpixeldungeon.items.trinkets.RatSkull;
import com.cheatedpixel.cheatedpixeldungeon.items.trinkets.SaltCube;
import com.cheatedpixel.cheatedpixeldungeon.items.trinkets.ShardOfOblivion;
import com.cheatedpixel.cheatedpixeldungeon.items.trinkets.ThirteenLeafClover;
import com.cheatedpixel.cheatedpixeldungeon.items.trinkets.TrapMechanism;
import com.cheatedpixel.cheatedpixeldungeon.items.trinkets.Trinket;
...
import com.cheatedpixel.cheatedpixeldungeon.items.trinkets.WondrousResin;
...
import com.cheatedpixel.cheatedpixeldungeon.items.wands.WandOfCorrosion;
import com.cheatedpixel.cheatedpixeldungeon.items.wands.WandOfCorruption;
...
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.AssassinsBlade;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.BattleAxe;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Crossbow;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Dagger;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Dirk;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Flail;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Gauntlet;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Glaive;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Gloves;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Greataxe;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Greatshield;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Greatsword;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.HandAxe;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Katana;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Longsword;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Mace;
...
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Quarterstaff;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Rapier;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.RoundShield;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.RunicBlade;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Sai;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Scimitar;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Shortsword;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Sickle;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Spear;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Sword;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.WarHammer;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.WarScythe;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.Whip;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.melee.WornShortsword;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.missiles.Bolas;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.missiles.FishingSpear;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.missiles.ForceCube;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.missiles.HeavyBoomerang;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.missiles.Javelin;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.missiles.Kunai;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.missiles.MissileWeapon;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.missiles.Shuriken;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.missiles.ThrowingClub;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.missiles.ThrowingHammer;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.missiles.ThrowingKnife;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.missiles.ThrowingSpear;
...
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.missiles.Tomahawk;
import com.cheatedpixel.cheatedpixeldungeon.items.weapon.missiles.Trident;
