...
package com.cheatedpixel.cheatedpixeldungeon.items.armor;
...
import com.cheatedpixel.cheatedpixeldungeon.items.armor.curses.AntiEntropy;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.curses.Bulk;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.curses.Corrosion;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.curses.Displacement;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.curses.Metabolism;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.curses.Multiplicity;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.curses.Overgrowth;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.curses.Stench;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.glyphs.Affection;
...
import com.cheatedpixel.cheatedpixeldungeon.items.armor.glyphs.Camouflage;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.glyphs.Entanglement;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.glyphs.Flow;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.glyphs.Obfuscation;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.glyphs.Potential;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.glyphs.Repulsion;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.glyphs.Stone;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.glyphs.Swiftness;
import com.cheatedpixel.cheatedpixeldungeon.items.armor.glyphs.Thorns;
	...
	public void execute(Hero hero, String action) {
		...
		if (action.equals(AC_DETACH) && seal != null){
			...
			if (detaching.level() > 0){
				for (int i = 0; i < (Cheats.isCheated(Cheats.USE_SEAL_LEVEL) ? detaching.level() : 1); i++){
					degrade();
				}
			}
