...
import com.cheatedpixel.cheatedpixeldungeon.sprites.FistSprite;
...
public abstract class YogFist extends Mob {
	...
	public void damage(int dmg, Object src) {
		...
		if (dmgTaken > 0 && lock != null && !isImmune(src.getClass()) && !isInvulnerable(src.getClass())){
			if (!Cheats.isCheated(Cheats.DISABLE_CHALLENGES_EFFECTS) && Dungeon.isChallenged(Challenges.STRONGER_BOSSES))   lock.addTime(dmgTaken/4f);
