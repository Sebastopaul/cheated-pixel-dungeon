...
package com.cheatedpixel.cheatedpixeldungeon.desktop;
...
import com.cheatedpixel.cheatedpixeldungeon.services.news.NewsImpl;
import com.cheatedpixel.cheatedpixeldungeon.services.updates.UpdateImpl;
	...
	public static void main (String[] args) {
		...
		Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
			...
			public void uncaughtException(Thread thread, Throwable throwable) {
				...
				exceptionMsg = exceptionMsg.replace("com.cheatedpixel.cheatedpixeldungeon.", "");
